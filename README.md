...
You can manually trigger the automation by running `./bin/trigger ingest --user <your-github-username>`.
See the output of `./bin/trigger ingest` for more information about authentication with GitHub.
